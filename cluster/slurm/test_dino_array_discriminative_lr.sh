#!/bin/bash
#SBATCH --job-name=gastrohun_dino_disclr_test
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --array=0-7
#SBATCH --output=logs/test_dino_disclr_%A_%a.out
#SBATCH --error=logs/test_dino_disclr_%A_%a.err
...
echo "Model: $MODEL, batch_size: $BATCH_SIZE, host: $(hostname)"
