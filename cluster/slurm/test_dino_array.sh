#!/bin/bash
#SBATCH --job-name=gastrohun_dino_test
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OUTPUT_DIR=~/Gastrohun_official/image_classification/output/Complete_agreement_40/${MODEL}/iter1
echo "Model: $MODEL, batch size: $BATCH_SIZE, host: $(hostname)"
